...
$(document).ready(function () {
  ...
  /*
    ...
    function select2Flags (state) {
      if (!state.id) { return state.text; }
      var $state = $(
          '<span class="flag-icon m-r flag-icon-' + state.element.getAttribute('data-flag') + '"></span><span>' + state.text + '</span>'
      );
      return $state;
  }
    */
...
__webpack_require__(/*! C:\Users\ana\Desktop\CODING\QGSecurity\iqgs5\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\ana\Desktop\CODING\QGSecurity\iqgs5\resources\sass\app.scss */"./resources/sass/app.scss");
